// Package shop is a small domain for exercising the mockery adapter: two
// collaborators behind interfaces, and a service wired over them.
package shop

//go:generate mockery --srcpkg . --name UserRepository --name RateRepository --name Audit --inpackage --with-expecter
